...
from poutyne.framework import Model, CSVLogger, Callback
...
cervo_dataset = CervoDataset(csv_file='data/raw/AI_FS_QC_img/data_AI_QC.csv',
                             root_dir='data/raw/AI_FS_QC_img/')
...
def create_unet():
  return nn.Sequential(
      nn.Conv2d(60, 1920, kernel_size=3, stride=2, bias=False),
      nn.BatchNorm2d(1920),
      nn.ReLU(),
      nn.Conv2d(1920, 1920, kernel_size=3, stride=2, bias=False),
      nn.BatchNorm2d(1920),
      nn.ReLU(),
      nn.MaxPool2d(kernel_size=2),

      nn.Conv2d(1920, 3840, kernel_size=3, stride=2, bias=False),
      nn.BatchNorm2d(3840),
      nn.ReLU(),
      nn.Conv2d(3840, 3840, kernel_size=3, stride=2, bias=False),
      nn.BatchNorm2d(3840),
      nn.ReLU(),
      nn.MaxPool2d(kernel_size=2),

      nn.Conv2d(3840, 7680, kernel_size=3, stride=2, bias=False),
      nn.BatchNorm2d(7680),
      nn.ReLU(),
      nn.Conv2d(7680, 7680, kernel_size=3, stride=2, bias=False),
      nn.BatchNorm2d(7680),
      nn.ReLU(),
      nn.MaxPool2d(kernel_size=2),

      nn.Conv2d(7680, 15360, kernel_size=3, stride=2, bias=False),
      nn.BatchNorm2d(15360),
      nn.ReLU(),
      nn.Conv2d(15360, 15360, kernel_size=3, stride=2, bias=False),
      nn.BatchNorm2d(15360),
      nn.ReLU(),
      nn.MaxPool2d(kernel_size=2),

      nn.Conv2d(15360, 30720, kernel_size=3, stride=2, bias=False),
      nn.ReLU(),
      nn.BatchNorm2d(30720),
      nn.Conv2d(30720, 30720, kernel_size=3, stride=2, bias=False),
      nn.BatchNorm2d(30720),
      nn.ReLU(),

      nn.ConvTranspose2d(30720, 15360, kernel_size=2, stride=2),
      nn.Conv2d(15360, 15360, kernel_size=3, stride=2, bias=False),
      nn.BatchNorm2d(15360),
      nn.ReLU(),
      nn.Conv2d(15360, 15360, kernel_size=3, stride=2, bias=False),
      ...
      nn.ConvTranspose2d(15360, 7680, kernel_size=2, stride=2),
      nn.Conv2d(7680, 7680, kernel_size=3, stride=2, bias=False),
      nn.ReLU(),
      nn.BatchNorm2d(7680),
      nn.Conv2d(7680, 7680, kernel_size=3, stride=2, bias=False),
      ...
      nn.ConvTranspose2d(7680, 3840, kernel_size=2, stride=2),
      nn.Conv2d(3840, 3840, kernel_size=3, stride=2, bias=False),
      nn.ReLU(),
      nn.BatchNorm2d(3840),
      nn.Conv2d(3840, 3840, kernel_size=3, stride=2, bias=False),
      ...
      nn.ConvTranspose2d(3840, 1920, kernel_size=2, stride=2),
      nn.Conv2d(1920, 1920, kernel_size=3, stride=2, bias=False),
      nn.ReLU(),
      nn.BatchNorm2d(1920),
      nn.Conv2d(1920, 1920, kernel_size=3, stride=2, bias=False),
      ...
      nn.Conv2d(1920, 60, kernel_size=1, stride=2),
      torch.sigmoid()
  )
